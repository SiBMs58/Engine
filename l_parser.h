	...
	*/
	...
	class LSystem
	{
		protected:
			...
			/**
			 * \brief Copy-constructor: creates a new ini from an existing ini
			 *
			 * \param system	The ini to be copied
			 */
		...
		public:
			/**
			 * \brief returns the Alphabet of the ini
			 *
			...
			/**
			 * \brief Returns the angle of the ini.
			 *
			...
			/**
			 * \brief Returns the initiator string of the ini
			 *
			 * \return 	the inititor string of the ini
			 */
	 ...
	 * \param system	The ini to be written
	 *
	 * \return		The outputstream the ini was written to
	 */
	 ...
	 * \param system	The ini object in which the parsed LSystem is to be stored
	 *
	 * \return		The input stream from which the ini was read
	 */
	...
	class LSystem2D: public LSystem
	{
		public:
			 ...
			 *
			 * \param in		The input stream from which the ini is to be read
			 */
			 ...
			 *
			 * \param system	The ini to be assigned to this object
			 */
			LSystem2D& operator=(LSystem2D const& system);

			/**
			 * \brief Returns the starting angle of the 2D ini
			 *
			 * \return 	the starting angle of the ini
			 * */
